...
import { Plus, Trash2, Pencil, Save, X, Upload } from "lucide-react";

const PartsEnquiryIdPage = ({ sidebarVisible }) => {
      ...
      <div style={styles.welcomeCard}>
        <div style={styles.combinedHeaderFilter}>
          <div style={styles.headerRow}>
            <h1 style={styles.title}>Request Parts Enquiry ID</h1>
          </div>
        ...
        <div style={styles.actionButtonsGroup}>
          <button
            ...
            onMouseEnter={(e) => handleButtonHover(e, true, "search")}
            onMouseLeave={(e) => handleButtonHover(e, false, "search")}
            onClick={() => navigate("/part-enquiry-id/add")}
          >
            <Plus size={16} />
            Create
          </button>
          <button
            ...
            onMouseEnter={(e) => handleButtonHover(e, true, "search")}
            onMouseLeave={(e) => handleButtonHover(e, false, "search")}
            onClick={() => navigate("/part-enquiry-id/upload")}
          >
            <Upload size={16} />
            Upload
          </button>
...
export default PartsEnquiryIdPage;
