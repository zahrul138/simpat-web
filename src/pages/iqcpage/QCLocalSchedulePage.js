...
const QCLocalSchedulePage = ({ sidebarVisible }) => {
  ...
  const tableConfig = {
    Schedule: {
      mainTable: {
        cols: ["26px", "26px", "15%", "15%", "12%", "8%", "8%", "8%", "30%"],
      },
      vendorTable: {
        marginLeft: "51.5px",
        cols: ["26px", "26px", "12%", "35%", "20%", "15%", "8%", "8%"],
      },
      partsTable: {
        marginLeft: "51px",
        cols: ["2%", "12%", "30%", "8%", "8%", "8%", "10%"],
      },
    },
    Today: {
      mainTable: {
        cols: ["26px", "25px", "15%", "15%", "12%", "8%", "8%", "8%", "30%"],
      },
      vendorTable: {
        marginLeft: "50.7px",
        cols: ["26px", "26px", "12%", "35%", "20%", "15%", "8%", "8%"],
  ...
  const handleAddSampleDate = async () => {
    ...
    if (existingProdDates.includes(newSampleDate)) {
      alert(
        "Error: This production date already exists. Please enter a different date.",
      );
      return;
    }
  ...
  const applyFilterLS_QCL = (arr, isSchedule = false) => {
  ...
  return (
    <div style={styles.pageContainer}>
      <div>
        <Helmet>
          <title>Quality Assurance | Local Schedule</title>
        </Helmet>
      </div>
