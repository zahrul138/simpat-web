...
const IQCLocalPage = ({ sidebarVisible }) => {
      ...
      <div style={styles.welcomeCard}>
        <div style={styles.combinedHeaderFilter}>
          <div style={styles.headerRow}>
            <h1 style={styles.title}>Control Local Part</h1>
          </div>
        ...
        {/* Add and Change buttons are now below the combined header/filter section */}
